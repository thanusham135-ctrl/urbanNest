...
(function () {
  ...
  mount.innerHTML = `
    <div id="float-cta">
      <div class="fcta-left">
        <div class="fcta-avatar">R</div>
        <div class="fcta-text">
          <div class="fcta-name">Rajan Mehta — Available Now</div>
          <div class="fcta-sub">Get your free 3D design preview today ✦</div>
        </div>
      </div>
      <div class="fcta-right">
        <a href="tel:+919876543210" class="fcta-btn fcta-call">📞 Call Free</a>
        <a href="https://wa.me/919876543210" class="fcta-btn fcta-wa" target="_blank">💬 WhatsApp</a>
